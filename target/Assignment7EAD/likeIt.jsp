...
<%
    ...
    System.out.println(like.getPost_id() + "," + like.getUser_id());
    ForumPost.addMyLike("jdbc:postgresql://localhost:5432/myForum_db?user=postgres&password=1991", like.getPost_id(),  like.getUser_id() );
